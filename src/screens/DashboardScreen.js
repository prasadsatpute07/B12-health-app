...
export default function DashboardScreen({ navigation }) {
  ...
  // Check if today's check-in is done — look at server streak date, server history, or local logs
  const checkedToday =
        ...
        <View style={styles.body}>
          ...
          <View style={styles.shortcuts}>
            ...
            <Shortcut
              ...
              badge="Coming Soon"
              onPress={() =>
                Alert.alert('History', 'Your full check-in history is coming soon!', [{ text: 'OK' }])
              }
            />
          </View>
...
function Shortcut({ emoji, label, badge, onPress }) {
  return (
...
const styles = StyleSheet.create({
  ...
  profileAvatar: {
    ...
    height: 44,
    borderRadius: 22,
    backgroundColor: 'rgba(0, 201, 167, 0.22)',
    borderWidth: 2,
  ...
  shortcutEmoji: { fontSize: 28, marginBottom: 2 },
  shortcutLabel: {
    fontSize: fontSizes.sm,
    fontWeight: fontWeights.semibold,
    color: colors.textSecondary,
